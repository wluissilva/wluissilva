...
### Senior QA Engineer | QA Automation | Selenium • Cypress • RestAssured

📍 Recife, Pernambuco, Brasil

![visitors](https://komarev.com/ghpvc/?username=wluissilva&label=Visualiza%C3%A7%C3%B5es&color=2E9EF7&style=flat)

---

## 🎯 Sobre mim

Senior QA Engineer com **13 anos de experiência** entregando qualidade em produtos digitais nos segmentos de **Varejo, Financeiro, Meios de Pagamento e Telecom**.

- 🧭 Estratégias de teste construídas junto ao time de desenvolvimento, com a **pirâmide de testes** como base para equilibrar cobertura, velocidade de feedback e custo de manutenção
- 🛡️ Abordagem **preventiva**: atuo na revisão de histórias, critérios de aceite e mapeamento de riscos ainda nas fases iniciais
- 📊 Construo e mantenho **dashboards de métricas de qualidade** (cobertura, taxa de defeitos, lead time, cycle time, evolução das automações) para dar visibilidade a devs, POs e stakeholders
- 🤖 Últimos 8 anos com **automação de testes** Web e API
...
![Tosca](https://img.shields.io/badge/Tricentis_Tosca-000000?style=for-the-badge)
![Cucumber](https://img.shields.io/badge/Cucumber_(BDD)-23D96C?style=for-the-badge&logo=cucumber&logoColor=white)
![JUnit](https://img.shields.io/badge/JUnit-25A162?style=for-the-badge&logo=junit5&logoColor=white)
![TestNG](https://img.shields.io/badge/TestNG-EA2D2E?style=for-the-badge)

**Performance, Qualidade & CI/CD**
